...
height = DoubleVar()
h_label = Label(root, text="heigh", fg="red", bg="black", font=("Calibri 14 bold"), pady=5, padx=8)
...
status = Label(root, text="Status", fg="blue", bg="black", font=("Calibri 14 bold"),padx=2, pady=10)
